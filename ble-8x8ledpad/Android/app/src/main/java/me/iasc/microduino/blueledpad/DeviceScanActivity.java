...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, LedMatrixActivity.class);
        intent.putExtra(LedMatrixActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(LedMatrixActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
