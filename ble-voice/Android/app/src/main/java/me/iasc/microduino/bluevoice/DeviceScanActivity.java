...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        returnIntent.putExtra(VoiceCmdUploadActivity.EXTRAS_DEVICE_NAME, device.getName());
        returnIntent.putExtra(VoiceCmdUploadActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
